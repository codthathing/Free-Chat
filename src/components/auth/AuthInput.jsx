  ...
  return (
    <>
      <div className="py-1 px-3 md:px-4 rounded-md md:rounded-xl has-[input:focus]:border-black lg:rounded-lg bg-[#F8F8F8] border-b-4 border-gray-light flex items-center lg:gap-y-1">
        <Field type={type === "password" ? (showPassword ? "text" : "password") : type} name={name} placeholder={placeholder} className="shadow-inset placeholder:text-[#C8C8C8] border-none outline-none bg-inherit py-2 px-1 md:py-3 lg:py-2 text-xs md:text-xl lg:text-sm w-full" />
